...
class DiterimaModel extends Model
{
    protected $table            = 'pelamar_diterima';
    ...
    public function  getDiterima($slug = false)
    {
        if ($slug == false) {
            return $this->findAll();
        }
    ...
    {
        return $this->like('nama_pelamar', $keyword)->orLike('posisi', $keyword);
    }
}
