    ...
    <div class="row">
        <div class="col">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h1 class="mb-3"> Form Pelamar</h1>
                        <form action="<?= base_url('pelamar/simpan'); ?>" method="post" enctype="multipart/form-data" id="form">
                            <?= csrf_field(); ?>
                            <div class="row mb-3">
                            ...
                            <div class="g-recaptcha" data-sitekey="6LeNtIYqAAAAAHImEY6Ptqj0bZ8qsrUOX8LTazaf"></div>
                            <?php if (session('errors') && isset(session('errors')['captcha'])): ?>
